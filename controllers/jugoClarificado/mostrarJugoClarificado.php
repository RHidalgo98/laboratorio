...
if (isset($_GET['periodoZafra']) && !empty($_GET['periodoZafra']) && isset($_GET['fechaIngreso']) && !empty($_GET['fechaIngreso'])) {
    try {
        ...
        $query = "SELECT idJugoClarificado, hora, observacion, color, brix, sac, mlGastado, fechaIngreso, periodoZafra 
...
<head>
    ...
    <title>Mostrar Jugo Clarificado</title>
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Registros de Jugo Clarificado</h1>
                    ...
                    <?php if (isset($_GET['periodoZafra']) && !empty($_GET['periodoZafra']) && isset($_GET['fechaIngreso']) && !empty($_GET['fechaIngreso'])): ?>
                        <div class="mb-4">
                            <a href="<?php echo BASE_PATH; ?>forms/registrarJugoClarificado.php?periodoZafra=<?php echo isset($_GET['periodoZafra']) ? urlencode($_GET['periodoZafra']) : ''; ?>&fechaIngreso=<?php echo isset($_GET['fechaIngreso']) ? urlencode($_GET['fechaIngreso']) : ''; ?>" class="btn btn-new">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="tablaJugoClarificado" class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($horas as $hora) {
                                                    if (isset($dataHora[$hora])) {
                                                        ...
                                                        $color = formatear_valor($row['color'], 0);
                                                        ...
                                                        $idJugoClarificado = $row['idJugoClarificado'];
                                                        ...
                                                        <td>
                                                            <a href='" . BASE_PATH . "controllers/jugoClarificado/editarJugoClarificado.php?id={$idJugoClarificado}' class='text-warning me-2 action-icons'>
                                                                <i class='fas fa-edit'></i>
                                                            </a>
                                                            <a href='" . BASE_PATH . "controllers/jugoClarificado/eliminarJugoClarificado.php?id={$idJugoClarificado}&periodoZafra={$periodoZafra}&fechaIngreso={$fechaIngreso}' class='text-danger action-icons' onclick='return confirm(\"¿Estás seguro de eliminar este registro?\")'>
    ...
    <script>
        $(document).ready(function() {
            $('#tablaJugoClarificado').DataTable({
                "paging": false,
                "searching": false,
                "info": false,
                "order": false,

        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Registros de Miel B</h1>
                    ...
                    <?php if (!empty($periodoZafra) && !empty($fechaIngreso)): ?>
                        <div class="mb-4">
                            <a href="<?= BASE_PATH ?>forms/registrarMielB.php?periodoZafra=<?php echo urlencode($periodoZafra); ?>&fechaIngreso=<?php echo urlencode($fechaIngreso); ?>" class="btn btn-primary">
                    ...
                    if (!empty($periodoZafra) && !empty($fechaIngreso)) {
                        try {
                            // Obtener registros de Miel B que coincidan con Masa Cocida B en `periodoZafra`, `fechaIngreso`, y `num`
                            // Ordenando por el campo `num` de Masa Cocida B
                            $query = "SELECT mib.idMielB, mib.num, mib.hora, mib.brix AS brix_miel, mib.pol AS pol_miel, mb.brix AS brix_masa, mb.pol AS pol_masa, mib.observacion
                                      FROM mielb mib
                                      LEFT JOIN masacocidab mb ON mib.periodoZafra = mb.periodoZafra AND mib.fechaIngreso = mb.fechaIngreso AND mib.num = mb.num
                                      WHERE mib.periodoZafra = :periodoZafra AND mib.fechaIngreso = :fechaIngreso
                                      ORDER BY mib.num ASC";
                            ...
                            if ($result) {
                                ...
                                echo "<table class='table table-bordered' id='tablaMielB' width='100%' cellspacing='0'>";
                                ...
                                foreach ($result as $row) {
                                    ...
                                    echo "<tr>
                                            ...
                                            <td>
                                                <a href='" . BASE_PATH . "controllers/mielB/editarMielB.php?id=" . urlencode($row['idMielB']) . "&periodoZafra=" . urlencode($periodoZafra) . "&fechaIngreso=" . urlencode($fechaIngreso) . "' class='text-warning me-2 action-icons'>
                                                    <i class='fas fa-edit'></i>
                                                </a>
                                                <a href='" . BASE_PATH . "controllers/mielB/eliminarMielB.php?id=" . urlencode($row['idMielB']) . "&periodoZafra=" . urlencode($periodoZafra) . "&fechaIngreso=" . urlencode($fechaIngreso) . "' 

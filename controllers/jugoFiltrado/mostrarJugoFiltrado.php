...
if (isset($_GET['periodoZafra']) && !empty($_GET['periodoZafra']) && isset($_GET['fechaIngreso']) && !empty($_GET['fechaIngreso'])) {
    try {
        ...
        $query = "SELECT idJugoFiltrado, hora, observacion, brix, sac, mlGastado, fechaIngreso, periodoZafra 
                  FROM jugofiltrado 
...
<head>
    ...
    <title>Mostrar Jugo Filtrado</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Registros de Jugo Filtrado</h1>
                    ...
                    <!-- Mensaje de selección de filtros -->
                    ...
                    <?php if (isset($_GET['periodoZafra']) && !empty($_GET['periodoZafra']) && isset($_GET['fechaIngreso']) && !empty($_GET['fechaIngreso'])): ?>
                        <div class="mb-4">
                            <a href="<?php echo BASE_PATH; ?>forms/registrarJugoFiltrado.php?periodoZafra=<?php echo urlencode($_GET['periodoZafra']); ?>&fechaIngreso=<?php echo urlencode($_GET['fechaIngreso']); ?>" class="btn btn-new">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="tablaJugoFiltrado" class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($horas as $hora) {
                                                    if (isset($dataHora[$hora])) {
                                                        ...
                                                        $idJugoFiltrado = $row['idJugoFiltrado'];
                                                        ...
                                                        echo "<tr>
                                                            ...
                                                            <td>
                                                                <a href='" . BASE_PATH . "controllers/jugoFiltrado/editarJugoFiltrado.php?id={$idJugoFiltrado}' class='text-warning me-2 action-icons'>
                                                                    <i class='fas fa-edit'></i>
                                                                </a>
                                                                <a href='" . BASE_PATH . "controllers/jugoFiltrado/eliminarJugoFiltrado.php?id={$idJugoFiltrado}&periodoZafra={$periodoZafra}&fechaIngreso={$fechaIngreso}' class='text-danger action-icons' onclick='return confirm(\"¿Estás seguro de eliminar este registro?\")'>

...
<head>
    ...
    <title>Mostrar Masa Cocida B</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Registros de Masa Cocida B</h1>
                    ...
                    <?php if (!empty($periodoZafra) && !empty($fechaIngreso)): ?>
                        <div class="mb-4">
                            <a href="<?= BASE_PATH ?>forms/registrarMasaCocidaB.php?periodoZafra=<?php echo urlencode($periodoZafra); ?>&fechaIngreso=<?php echo urlencode($fechaIngreso); ?>" class="btn btn-primary">
                    ...
                    if (!empty($periodoZafra) && !empty($fechaIngreso)) {
                        ...
                        $query = "SELECT mb.idMasaCocidaB, mb.num, mb.hora, mb.tacho, mb.volFt3, mb.brix, mb.pol, mb.periodoZafra, mb.fechaIngreso, 
                                         mib.brix AS brix_miel, mib.pol AS pol_miel, mb.observacion
                                  FROM masacocidab mb
                                  LEFT JOIN mielb mib ON mb.periodoZafra = mib.periodoZafra AND mb.fechaIngreso = mib.fechaIngreso AND mb.num = mib.num
                                  WHERE mb.periodoZafra = :periodoZafra AND mb.fechaIngreso = :fechaIngreso
                                  ORDER BY mb.num ASC";
                        ...
                        if (!empty($periodoZafra) && !empty($fechaIngreso)) {
                            try {
                                ...
                                $queryMasa = "SELECT SUM(pol) AS sumPolMasa, SUM(brix) AS sumBrixMasa FROM masacocidab
                                ...
                                $queryMiel = "SELECT SUM(pol) AS sumPolMiel, SUM(brix) AS sumBrixMiel, COUNT(*) AS countMiel FROM mielb
                                              WHERE periodoZafra = :periodoZafra AND fechaIngreso = :fechaIngreso AND brix > 0";
                        ...
                        if ($result) {
                            ...
                            echo "<table class='table table-bordered' id='tablaMasaCocidaB' width='100%' cellspacing='0'>";
                            ...
                            foreach ($result as $row) {
                                ...
                                $idMasaCocidaB = $row['idMasaCocidaB'];
                                ...
                                echo "<tr>
                                        ...
                                        <td>
                                            <a href='" . BASE_PATH . "controllers/masaCocidaB/editarMasaCocidaB.php?id=" . urlencode($idMasaCocidaB) . "&periodoZafra=" . urlencode($periodoZafra) . "&fechaIngreso=" . urlencode($fechaIngreso) . "' class='text-warning me-2 action-icons'>
                                                <i class='fas fa-edit'></i>
                                            </a>
                                            <a href='" . BASE_PATH . "controllers/masaCocidaB/eliminarMasaCocidaB.php?id=" . urlencode($idMasaCocidaB) . "&periodoZafra=" . urlencode($periodoZafra) . "&fechaIngreso=" . urlencode($fechaIngreso) . "' 

...
if (isset($_GET['id'])) {
    ...
    try {
        $stmt = $conexion->prepare("SELECT * FROM bagazo WHERE idBagazo = :idBagazo");
        $stmt->bindParam(':idBagazo', $idBagazo, PDO::PARAM_INT);
        $stmt->execute();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($error)) {
        try {
            ...
            $check_stmt->bindParam(':idBagazo', $idBagazo);
            $check_stmt->execute();
    ...
    if (empty($error)) {
        try {
            ...
            $stmt->bindParam(':idBagazo', $idBagazo);
        ...
        header("Location: " . BASE_PATH . "controllers/bagazo/editarBagazo.php?id=" . urlencode($idBagazo) . "&error=" . urlencode($error));
        exit();
    }
}
?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">Editar Registro de Bagazo</h1>
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" id="pol" name="pol" class="form-control" step="0.01" value="<?= htmlspecialchars($registro['pol']); ?>" min="0">
                                    </div>
                                    <div class="col-md-6">

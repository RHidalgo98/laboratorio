...
if (isset($_GET['periodoZafra']) && !empty($_GET['periodoZafra']) && isset($_GET['fechaIngreso']) && !empty($_GET['fechaIngreso'])) {
    try {
        ...
        $query = "SELECT idMeladura, hora, observacion, color, brix, sac, mlGastado, fechaIngreso, periodoZafra 
                  FROM meladura 
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Registros de Meladura</h1>
                    ...
                    <?php if (isset($_GET['periodoZafra']) && !empty($_GET['periodoZafra']) && isset($_GET['fechaIngreso']) && !empty($_GET['fechaIngreso'])): ?>
                        <div class="mb-4">
                            <a href="<?php echo BASE_PATH; ?>forms/registrarMeladura.php?periodoZafra=<?php echo isset($_GET['periodoZafra']) ? urlencode($_GET['periodoZafra']) : ''; ?>&fechaIngreso=<?php echo isset($_GET['fechaIngreso']) ? urlencode($_GET['fechaIngreso']) : ''; ?>" class="btn btn-new">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="tablaMeladura" class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($horas as $hora) {
                                                    if (isset($dataHora[$hora])) {
                                                        ...
                                                        <td>
                                                            <a href='" . BASE_PATH . "controllers/meladura/editarMeladura.php?id={$idMeladura}' class='text-warning me-2 action-icons'>
                                                                <i class='fas fa-edit'></i>
                                                            </a>
                                                            <a href='" . BASE_PATH . "controllers/meladura/eliminarMeladura.php?id={$idMeladura}&periodoZafra={$periodoZafra}&fechaIngreso={$fechaIngreso}' class='text-danger action-icons' onclick='return confirm(\"¿Estás seguro de eliminar este registro?\")'>

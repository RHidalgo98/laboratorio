...
if (isset($_GET['periodoZafra']) && !empty($_GET['periodoZafra']) && isset($_GET['fechaIngreso']) && !empty($_GET['fechaIngreso'])) {
    try {
        ...
        $query = "SELECT idJugoMezclado, hora, observacion, fosfato, brix, sac, mlGastado, fechaIngreso, periodoZafra 
                  FROM jugomezclado 
...
<head>
    ...
    <title>Mostrar Jugo Mezclado</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php if (isset($_GET['periodoZafra']) && !empty($_GET['periodoZafra']) && isset($_GET['fechaIngreso']) && !empty($_GET['fechaIngreso'])): ?>
                        <div class="mb-4">
                            <a href="<?php echo BASE_PATH; ?>forms/registrarJugoMezclado.php?periodoZafra=<?php echo isset($_GET['periodoZafra']) ? urlencode($_GET['periodoZafra']) : ''; ?>&fechaIngreso=<?php echo isset($_GET['fechaIngreso']) ? urlencode($_GET['fechaIngreso']) : ''; ?>" class="btn btn-new">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="tablaJugoMezclado" class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($horas as $hora) {
                                                    if (isset($dataHora[$hora])) {
                                                        ...
                                                        $fosfato = formatear_valor($row['fosfato'], 0);
                                                        ...
                                                        $idJugoMezclado = $row['idJugoMezclado'];
                                                        ...
                                                        <td>
                                                            <a href='" . BASE_PATH . "controllers/jugoMezclado/editarJugoMezclado.php?id={$idJugoMezclado}' class='text-warning me-2 action-icons'>
                                                                <i class='fas fa-edit'></i>
                                                            </a>
                                                            <a href='" . BASE_PATH . "controllers/jugoMezclado/eliminarJugoMezclado.php?id={$idJugoMezclado}&periodoZafra={$periodoZafra}&fechaIngreso={$fechaIngreso}' class='text-danger action-icons' onclick='return confirm(\"¿Estás seguro de eliminar este registro?\")'>

...
<head>
    ...
    <title>Registro de Jugo Mezclado</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Registro de Jugo Mezclado</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form action="<?php echo BASE_PATH; ?>controllers/jugoMezclado/insertarJugoMezclado.php" method="POST">
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="fosfato" name="fosfato" class="form-control" step="0.01" min="0" value="<?php echo isset($_GET['fosfato']) ? $_GET['fosfato'] : ''; ?>" placeholder="Ejemplo: 13,523">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <a href="<?php echo BASE_PATH; ?>controllers/jugoMezclado/mostrarJugoMezclado.php?periodoZafra=<?php echo isset($_GET['periodoZafra']) ? urlencode($_GET['periodoZafra']) : ''; ?>&fechaIngreso=<?php echo isset($_GET['fechaIngreso']) ? urlencode($_GET['fechaIngreso']) : ''; ?>" class="btn btn-secondary">Regresar</a>
                                </div>
                            </form>
                        </div>
                    </div>

...
<head>
    ...
    <title>Registro de Masa Cocida C</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">Registro de Masa Cocida C</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form action="<?= BASE_PATH ?>controllers/masaCocidaC/insertarMasaCocidaC.php" method="POST">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="num" name="num" class="form-control" placeholder="Ingrese el número" min="1" step="1" value="<?= htmlspecialchars($num); ?>" required>
                                </div>

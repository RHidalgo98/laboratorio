...
$azucRed = isset($_GET['azucRed']) ? $_GET['azucRed'] : '';
...
<head>
    ...
    <title>Registro de Miel Final</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">Registro de Miel Final</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form action="<?= BASE_PATH ?>controllers/mielFinal/insertarMielFinal.php?periodoZafra=<?= urlencode($periodoZafra) ?>&fechaIngreso=<?= urlencode($fechaIngreso) ?>" method="POST">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="num" name="num" class="form-control" required placeholder="Ingrese el número" min="1" step="1">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="azucRed" class="form-label">Azúcar Reducido:</label>
                                    <input type="number" id="azucRed" name="azucRed" class="form-control" step="0.01" min="0" value="<?= htmlspecialchars($azucRed); ?>" placeholder="Ejemplo: 39.40">
                                </div>
                                <div class="mb-3">

            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form action="<?= BASE_PATH ?>controllers/jugoMezcladoPHMBC/insertarJugoMezcladoPHMBC.php" method="POST">
                                <div class="mb-3">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <a href="<?= BASE_PATH ?>controllers/jugoMezcladoPHMBC/mostrarJugoMezcladoPHMBC.php?periodoZafra=<?= urlencode($periodoZafra); ?>&fechaIngreso=<?= urlencode($fechaIngreso); ?>" class="btn btn-secondary">Regresar</a>
                                </div>
                            </form>
                        </div>
                    </div>

...
$fibra = isset($_GET['fibra']) ? $_GET['fibra'] : '';
...
<head>
    ...
    <title>Registro de Cachaza</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">Registro de Cachaza</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form action="<?= BASE_PATH ?>controllers/cachaza/insertarCachaza.php" method="POST">
                                <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" id="humedad" name="humedad" class="form-control" step="0.01" min="0" value="<?= htmlspecialchars($humedad); ?>" placeholder="Ejemplo: 0.00" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="fibra" class="form-label">Fibra:</label>
                                        <input type="number" id="fibra" name="fibra" class="form-control" step="0.01" min="0" value="<?= htmlspecialchars($fibra); ?>" placeholder="Ejemplo: 0.00" required>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-12">

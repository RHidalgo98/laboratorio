...
<head>
    ...
    <title>Registro de Jugo Residual</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Registro de Jugo Residual</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form action="<?php echo BASE_PATH; ?>controllers/jugoResidual/insertarJugoResidual.php" method="POST">
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <a href="<?php echo BASE_PATH; ?>controllers/jugoResidual/mostrarJugoResidual.php?periodoZafra=<?php echo isset($_GET['periodoZafra']) ? urlencode($_GET['periodoZafra']) : ''; ?>&fechaIngreso=<?php echo isset($_GET['fechaIngreso']) ? urlencode($_GET['fechaIngreso']) : ''; ?>" class="btn btn-secondary">Regresar</a>
                                </div>
                            </form>
                        </div>
                    </div>

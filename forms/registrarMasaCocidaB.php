...
$sqlNum = "SELECT COALESCE(MAX(num), 0) + 1 AS next_num FROM masacocidab WHERE periodoZafra = :periodoZafra AND fechaIngreso = :fechaIngreso";
...
<head>
    ...
    <title>Registro de Masa Cocida B</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">Registro de Masa Cocida B</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form action="<?= BASE_PATH ?>controllers/masaCocidaB/insertarMasaCocidaB.php" method="POST">
                                <div class="mb-3">
